...
#' @param A Empirical coefficient (default=0.75)
#' @param C Empirical coefficient (default=2.4)
#' @param opt average diurnal temperature methods: 1day (default), 2day and missingdays
#' @param JD Julian Day (default=NULL)
#'
