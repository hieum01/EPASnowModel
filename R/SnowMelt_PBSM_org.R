#' PBSM snow
#'
#' Original PBSM snow model that requires only precipitation and temperature
#'
...
#' @examples
SnowMelt_PBSM_org<-function(Date, precip_mm, Tmax_C, Tmin_C, lat_deg, slope=0, aspect=0, tempHt=1, windHt=2, groundAlbedo=0.25, 		SurfEmissiv=0.95, windSp=2, forest=0, startingSnowDepth_m=0, startingSnowDensity_kg_m3=450){
  ## Constants :
